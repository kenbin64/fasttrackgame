...
const GameFlowTest = {
    ...
    testURLParameters() {
        ...
        const offlineURL = new URL('http://localhost/board_3d.html?offline=true');
        ...
        const privateURL = new URL('http://localhost/board_3d.html?code=ABC123');
        ...
        const publicURL = new URL('http://localhost/board_3d.html?session=xyz789');
    ...
    testGameTypeDetection() {
        ...
        const scenarios = [
            {
                url: 'board_3d.html?offline=true',
                expected: 'offline',
                description: 'Human vs AI offline game'
            },
            {
                url: 'board_3d.html?code=ABC123',
                expected: 'private',
                description: 'Private multiplayer game with code'
            },
            {
                url: 'board_3d.html?session=xyz789',
                expected: 'public',
    ...
    testNavigationFlows() {
        ...
        this.assert(
            true,
            'AI Setup wizard navigates to board_3d.html?offline=true',
        ...
        this.assert(
            true,
            'Private game creation navigates to board_3d.html?code=XXXXX',
        ...
        this.assert(
            true,
            'Join by code navigates to board_3d.html?code=XXXXX',
        ...
        this.assert(
            true,
            'Public lobby navigates to board_3d.html?session=XXXXX',
    ...
    testExistingGameButton() {
        ...
        const existingGameScenarios = [
            {
                storedURL: 'board_3d.html?offline=true',
                description: 'Resume offline game'
            },
            {
                storedURL: 'board_3d.html?code=ABC123',
                description: 'Resume private game'
            },
            {
                storedURL: 'board_3d.html?session=xyz789',
    ...
    testAISetupWizard() {
        ...
        const wizardSteps = [
            ...
            'Start game -> Navigate to board_3d.html?offline=true'
        ];
    ...
    testPrivateGameWizard() {
        ...
        const wizardSteps = [
            ...
            'Create game -> Navigate to board_3d.html?code=XXXXX',
    ...
    testJoinByCodeWizard() {
        ...
        const wizardSteps = [
            ...
            'Join game -> Navigate to board_3d.html?code=XXXXX',
    ...
    testPublicLobbyWizard() {
        ...
        const wizardSteps = [
            ...
            'Navigate to board_3d.html?session=XXXXX',
    ...
    testPageRouting() {
        ...
        const routingFlows = [
            {
                flow: 'index.html -> ai_setup.html -> board_3d.html?offline=true',
                backButton: 'Should return to index.html',
                description: 'AI game creation flow'
            },
            {
                flow: 'index.html -> lobby.html?action=private -> board_3d.html?code=XXX',
                backButton: 'Should return to index.html',
                description: 'Private game creation flow'
            },
            {
                flow: 'index.html -> lobby.html?action=join -> board_3d.html?code=XXX',
                backButton: 'Should return to index.html',
                description: 'Join by code flow'
            },
            {
                flow: 'index.html -> play.html -> lobby.html -> board_3d.html?session=XXX',
